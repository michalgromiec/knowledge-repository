...
* in most cases responsible for encryption in whole AWS
* fuly integrated with IAM for authorization
* integrated with
  * EBS - encrypt volumes
...
* user doesnt have direct access to key (see below Step by Step instruction)
